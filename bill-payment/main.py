...
# funtion to handel the bill payment process.
...
def pay_bills():
    ...
    if confirm == 'yes':
        ...
        print("Pyament cancelled")

#function to view payment histroy
...
def view_payment_history():
    ...
    if not payment_history:
        ...
        for payment in payment_history:
            ...
            print (f"Bill: {payment["bill_name"]}, Amount: {payment["amount"]}, Date: {payment["date"]}")
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("Existing the app. Thank you!")

            break
        
        else: 

            print("Invalid choice. Please select an valid option.")
